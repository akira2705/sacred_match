    ...
    features: [
        {
            ...
            description: "Profiles and filters respect ethnic identity, faith, location, and openness to cross-cultural matches without flattening people into generic swipes.",
            cta: "Explore compatibility",
        },
        {
            id: "matching",
            title: "Serious compatibility matching",
            description: "Recommendations balance shared values, marriage intent, geography, lifestyle fit, and mutual openness so the product stays focused on real long-term potential.",
            cta: "See scoring logic",
        },
        {
            id: "genotype",
            title: "Genetic compatibility checks",
            description: "Genotype visibility and compatibility give couples a structured way to make informed decisions about sickle cell risk before relationships become difficult to unwind.",
            cta: "Learn about genotype",
        },
        {
            id: "conversations",
            title: "Intentional conversation flow",
            description: "Once two people connect, the experience should help them talk with clarity and pace instead of collapsing into casual, low-signal chat behavior.",
            cta: "Review the connection flow",
        },
        {
            id: "safety",
            title: "Trust-first verification",
            description: "Identity, phone, email, and safety moderation foundations are planned from day one so growth does not come at the expense of trust.",
            cta: "Read safety standards",
        },
        {
            id: "stories",
            title: "Success stories with substance",
            description: "The experience highlights why a match made sense, what compatibility signals mattered, and how the relationship progressed beyond first impressions.",
            cta: "Read stories",
        },
    ],
    safetyPillars: [
    ...
    testimonials: [
        {
            ...
            story: "We needed more than age and city filters. Sacred Match surfaced values, genotype compatibility, and relationship intent early enough to take the connection seriously.",
        ...
        },
        {
            ...
            story: "The product let us move at the right pace, discuss genotype compatibility early, and focus on whether the connection was truly right for marriage.",
        ...
        },
        {
            ...
            story: "The biggest difference was clarity. We could see compatibility signals upfront instead of guessing whether we were aligned on the things that matter long term.",
    ...
    resources: [
        {
            ...
            excerpt: "A practical guide to genotype language, risk, and why couples in Nigeria talk about it early.",
            readTime: "5 min read",
            category: "Genotype",
        },
        {
            title: "Building a marriage-ready profile that attracts serious matches",
            excerpt: "How to present intent, values, and lifestyle clearly so the right people can recognize alignment faster.",
            readTime: "6 min read",
            category: "Profiles",
        },
        {
            title: "Cross-ethnic marriages in Nigeria: making it work",
            excerpt: "A grounded guide to communication, expectations, and compatibility when two backgrounds come together.",
            readTime: "6 min read",
