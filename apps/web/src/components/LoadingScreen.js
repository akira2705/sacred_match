...
export function LoadingScreen() {
    ...
    const t = (fn, ms) => { timerRef.current.push(setTimeout(fn, ms)); };
    ...
    return (_jsxs(_Fragment, { children: [_jsx("div", { className: "fixed top-0 left-0 z-[9999] h-full w-1/2 select-none", style: {
                    ...
                    overflow: "hidden",
                }, children: particles.filter(p => p.x < 50).map(p => (_jsx("div", { className: "absolute rounded-full", style: {
                        left: `${p.x * 2}%`,
                        top: `${p.y}%`,
                        width: p.size,
                        height: p.size,
                    ...
                    } }, p.id))) }), _jsx("div", { className: "fixed top-0 right-0 z-[9999] h-full w-1/2 select-none", style: {
                    ...
                    overflow: "hidden",
                        ...
                        borderRadius: "50%",
                        animation: `smFloat ${p.duration}s ease-in-out ${p.delay}s infinite alternate`,
                    } }, p.id))) }), _jsxs("div", { className: "fixed inset-0 z-[10000] flex flex-col items-center justify-center select-none pointer-events-none", style: {
                    opacity: isExiting ? 0 : 1,
                    transition: isExiting ? "opacity 0.6s ease" : "none",
                }, children: [flashVisible && (_jsx("div", { className: "absolute rounded-full", style: {
                            ...
                            animation: "smFlash 0.25s ease-out forwards",
                        } })), _jsxs("div", { className: "relative mb-6", children: [_jsxs("svg", { width: "120", height: "120", viewBox: "0 0 120 120", style: { overflow: "visible" }, children: [_jsx("defs", { children: _jsxs("linearGradient", { id: "smGoldStroke", x1: "0%", y1: "0%", x2: "100%", y2: "100%", children: [_jsx("stop", { offset: "0%", stopColor: "#C9A227" }), _jsx("stop", { offset: "50%", stopColor: "#F5E17D" }), _jsx("stop", { offset: "100%", stopColor: "#C9A227" })] }) }), _jsx("circle", { cx: "60", cy: "60", r: R, fill: "none", stroke: "rgba(201,162,39,0.06)", strokeWidth: "1" }), _jsx("g", { style: {
                                            transformOrigin: "60px 60px",
                                            animation: isLoading ? "smRingSpin 1.8s linear infinite" : "none",
                                            transform: isLoading ? undefined : "rotate(0deg)",
                                        }, children: _jsx("circle", { cx: "60", cy: "60", r: R, fill: "none", stroke: "url(#smGoldStroke)", strokeWidth: "1.5", strokeLinecap: "round", strokeDasharray: CIRC, strokeDashoffset: ringOffset, style: {
                                                transition: pastLoading ? "stroke-dashoffset 0.45s ease" : "none",
                                                filter: pastLoading ? "drop-shadow(0 0 6px rgba(201,162,39,0.7))" : "none",
                                            } }) }), pastLoading && diamonds.map((d, idx) => (_jsx("rect", { x: d.cx - 2.5, y: d.cy - 2.5, width: 5, height: 5, fill: "#F5E17D", transform: `rotate(45 ${d.cx} ${d.cy})`, style: {
                                            opacity: 0,
                                            animation: `smFadeIn 0.35s ease ${0.1 + idx * 0.08}s forwards`,
                                        } }, d.deg)))] }), _jsx("div", { className: "absolute inset-0 flex items-center justify-center", style: {
                                ...
                                }, children: "SM" })] }), _jsxs("div", { className: "relative flex items-center justify-center w-full mb-5", style: { height: 2 }, children: [_jsx("div", { className: "absolute right-1/2", style: {
                                    height: 2,
                                    ...
                                    zIndex: 1,
                                } }), _jsx("div", { className: "absolute left-1/2", style: {
                                    height: 2,
                                    width: linesShot ? "min(38vw, 300px)" : "0px",
                                ...
                                } })] }), _jsx("div", { className: "flex items-center justify-center mb-1", style: { minHeight: "3.5rem", perspective: "800px" }, children: SACRED.map((char, i) => {
                        ...
                        }) }), _jsx("div", { className: "flex items-center justify-center mb-5", style: { minHeight: "3.5rem", perspective: "800px" }, children: MATCH.map((char, i) => {
                            ...
                            return (_jsx("span", { style: {
                        ...
                        }) }), _jsxs("div", { className: "relative flex items-center justify-center w-full mb-4", style: { height: 14 }, children: [_jsxs("svg", { className: "absolute", style: {
                                    right: "calc(50% + 12px)",
                                    width: filigreeOpen ? "min(28vw, 200px)" : "0px",
                                    height: 14,
                                    overflow: "visible",
                                    transition: "width 0.7s cubic-bezier(0.16, 1, 0.3, 1) 0.1s",
                                }, viewBox: "0 0 200 14", preserveAspectRatio: "xMaxYMid meet", children: [_jsx("line", { x1: "200", y1: "7", x2: "20", y2: "7", stroke: "#C9A227", strokeWidth: "1", opacity: "0.6" }), _jsx("line", { x1: "200", y1: "7", x2: "40", y2: "7", stroke: "#C9A227", strokeWidth: "0.5", opacity: "0.3" }), _jsx("circle", { cx: "20", cy: "7", r: "2.5", fill: "#F5E17D" }), _jsx("polygon", { points: "6,7 11,3 16,7 11,11", fill: "#C9A227", opacity: "0.7" })] }), _jsx("div", { style: {
                                    fontSize: "0.65rem",
                                    color: "#F5E17D",
                                ...
                                }, children: "\u2726" }), _jsxs("svg", { className: "absolute", style: {
                                    left: "calc(50% + 12px)",
                                    width: filigreeOpen ? "min(28vw, 200px)" : "0px",
                                    height: 14,
                                    overflow: "visible",
                                    transition: "width 0.7s cubic-bezier(0.16, 1, 0.3, 1) 0.1s",
                                }, viewBox: "0 0 200 14", preserveAspectRatio: "xMinYMid meet", children: [_jsx("line", { x1: "0", y1: "7", x2: "180", y2: "7", stroke: "#C9A227", strokeWidth: "1", opacity: "0.6" }), _jsx("line", { x1: "0", y1: "7", x2: "160", y2: "7", stroke: "#C9A227", strokeWidth: "0.5", opacity: "0.3" }), _jsx("circle", { cx: "180", cy: "7", r: "2.5", fill: "#F5E17D" }), _jsx("polygon", { points: "184,7 189,3 194,7 189,11", fill: "#C9A227", opacity: "0.7" })] })] }), _jsx("p", { style: {
                            fontFamily: "Georgia, 'Times New Roman', serif",
                            fontSize: "0.65rem",
                        ...
                        }, children: "Serious connections only" })] })] }));
}
