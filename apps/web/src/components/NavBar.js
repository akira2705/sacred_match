...
const desktopLinkClass = "relative inline-flex h-11 shrink-0 items-center whitespace-nowrap rounded-full px-4 text-sm font-semibold tracking-tight text-brand-forest/75 transition-all duration-300 ease-out hover:-translate-y-[1px] hover:bg-white hover:text-brand-ink";
const measurementClass = "pointer-events-none absolute left-[-9999px] top-0 -z-50 opacity-0 overflow-hidden";
