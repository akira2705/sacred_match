...
const DEFAULT_DESCRIPTION = "Sacred Match is Nigeria's premium matrimony platform for culture-first compatibility, genotype awareness, and serious marriage-minded connections.";
const DEFAULT_OG_IMAGE = "https://sacred-match.ng/og-image.png";
export function Seo({ title, description, canonical, ogImage, noIndex }) {
